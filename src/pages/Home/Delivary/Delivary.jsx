    ...
    <div id="delivary-part">
      <Container>
        <div className="delivery-head hidden sm:block">
          <p className="lg:text-2xl md:text-2xl sm:text-1xl secondaryFont secondaryTextColor text-center">
            Our Delivery
          </p>
          <h1 className="lg:text-5xl primaryFont primaryTextColor font-bold text-center mb-4">
            This is our super <br /> delivery system
          </h1>
        </div>
