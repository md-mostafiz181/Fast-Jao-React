        ...
        <div id='contact-part'>
            <Container>
                <div className="contact-container grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-3">
                    <div className="contact-form bg-white h-[510px] rounded-lg mt-2">
                    ...
                    <div className="contact-details grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-3  py-2 px-2">
                        <div className="details-box flex justify-center items-center w-full">
                        ...
                        <h3 className='text-2xl secondaryFont primaryTextColor font-bold'>Delivered Packages</h3>
                        ...
                        <h3 className='text-2xl secondaryFont primaryTextColor font-bold'>Countries Covered</h3>
                        <div className="line"></div>
                        </div>
                        ...
                        <h3 className='text-2xl secondaryFont primaryTextColor font-bold'>Tons of Goods</h3>
                        <div className="line"></div>
                        </div>
                        ...
                        <h3 className='text-2xl secondaryFont primaryTextColor font-bold'>Satisfied Client</h3>
                        <div className="line"></div>
                        </div>
